...
public class DFSWinesHarbourFrontDetailFragment extends Fragment {

    public DFSWinesHarbourFrontDetailFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        locationDetail.add(new Location(getString(R.string.dfs_wines_harbourfront_title), getString(R.string.dfs_wines_harbourfront_content), R.drawable.image_dfs_harbourfront));
        ...
        phoneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + getString(R.string.dfs_wines_harbourfront_phone)));
        ...
        websiteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse(getString(R.string.dfs_wines_harbourfront_website)));
                startActivity(i);
            }
        });
        ...
        locationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("geo:0,0?q=" + getString(R.string.dfs_wines_harbourfront_location));
