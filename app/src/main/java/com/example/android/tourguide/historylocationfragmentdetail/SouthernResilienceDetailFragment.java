...
public class SouthernResilienceDetailFragment extends Fragment {
    public SouthernResilienceDetailFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        locationDetail.add(new Location(getString(R.string.southern_resilience_title), getString(R.string.southern_resilience_content), R.drawable.image_southern_resilience));
        ...
        phoneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + getString(R.string.southern_resilience_phone)));
        ...
        websiteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse(getString(R.string.southern_resilience_website)));
                startActivity(i);
            }
        });
        ...
        locationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("geo:0,0?q=" + getString(R.string.southern_resilience_location));
