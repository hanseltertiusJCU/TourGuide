...
public class TangsDetailFragment extends Fragment {

    public TangsDetailFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        locationDetail.add(new Location(getString(R.string.tangs_title), getString(R.string.tangs_content), R.drawable.image_tangs));
...
//                .setActionBarTitle(getString(R.string.tangs_title));
//
//    }
}
