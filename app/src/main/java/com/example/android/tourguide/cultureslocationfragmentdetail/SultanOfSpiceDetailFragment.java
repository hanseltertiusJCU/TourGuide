...
public class SultanOfSpiceDetailFragment extends Fragment{

    // Constructor for calling an object
    public SultanOfSpiceDetailFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        locationDetail.add(new Location(getString(R.string.sultan_of_spice_title), getString(R.string.sultan_of_spice_content), R.drawable.image_sultan_of_spice));
        ...
        phoneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + getString(R.string.sultan_of_spice_phone)));
        ...
        websiteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse(getString(R.string.sultan_of_spice_website)));
                startActivity(i);
            }
        });
        ...
        locationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("geo:0,0?q=" + getString(R.string.sultan_of_spice_location));
