...
public class EsplanadeDetailFragment extends Fragment {

    public EsplanadeDetailFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        locationDetail.add(new Location(getString(R.string.esplanade_title), getString(R.string.esplanade_content), R.drawable.image_esplanade));
        ...
        phoneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + getString(R.string.esplanade_phone)));
        ...
        websiteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse(getString(R.string.esplanade_website)));
                startActivity(i);
            }
        });
        ...
        locationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("geo:0,0?q=" + getString(R.string.esplanade_location));
