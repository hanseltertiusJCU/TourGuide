...
public class EvertonDetailFragment extends Fragment {

    public EvertonDetailFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        locationDetail.add(new Location(getString(R.string.everton_title), getString(R.string.everton_content), R.drawable.image_everton));
        ...
        websiteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse(getString(R.string.everton_website)));
                startActivity(i);
            }
        });
        ...
        locationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("geo:0,0?q=" + getString(R.string.everton_location));
